...
<body>
	...
	<div class="i_bg">
		<div class="postion">
			...
			<input type="hidden" name="product_stock" value="${p.stock }">
		<div class="content">
			<div id="tsShopContainer">
				<div id="tsImgS">
					<a href="files/${p.fileName }" title="Images" class="MagicZoom"
						id="MagicZoom"><img src="files/${p.fileName }" width="390"
						height="390" /></a>
				</div>
			...
			<div class="pro_des">
				...
				<div class="des_join">
					...
					<span class="fl">
						<a onclick="addCart('${user.id }','${p.id }')">
			...
			<div class="white_d">
				...
				<div class="notice_c">
					...
					<table border="0" align="center" style="margin-top:;"
						...
						<tr height="50" valign="bottom">
							<td>&nbsp;</td>
							<td><a href="BuyCar.jsp" class="b_sure">去购物车结算</a><a href="Product.jsp"
...
<script type="text/javascript">
	var jq = jQuery.noConflict();
	var stock = $("input[name='product_stock']").val();//库存
	function addCart(userId,prodId){
		var BuyNum = parseInt($(".n_ipt").val());
		if($("#login_lable").text() == "请登录" || $("#login_lable").text() == null || $("#login_lable").text() == ""){
			$("#car_span").html("您现在没有登录，无法加入购物车，<lable id='login_lable'>请<a href='Login.jsp'>登录</a></lable>")
			return;
		}
		window.location.href="${pageContext.request.contextPath}/AddCartServlet?userId="+userId+"&prodId="+ prodId+"&BuyNum="+BuyNum;
	}
	$(".n_ipt").blur(function(){
